...
import { ListEventsResponse, useListEvents } from "@/api/events";
...
function RouteComponent() {
  ...
  const { data: events, isError: isEventsError, isLoading: isEventsLoading, isSuccess: isEventsSuccess } = useListEvents(chartId);
